...
urlpatterns = [
    ...
    path('swolemates/post/<int:post_id>/add_like', views.home_post_add_like),
    path('swolemates/post/<int:post_id>/remove_like', views.home_post_remove_like),
    path('swolemates/post/<int:post_id>/add_comment', views.home_post_add_comment),
    path('swolemates/post/<int:post_id>/comment/<int:comment_id>/delete', views.home_post_delete_comment),
    path('swolemates/comment/<int:comment_id>/add_like', views.home_comment_add_like),
    path('swolemates/comment/<int:comment_id>/remove_like', views.home_comment_remove_like),
